...
#. Battery Voltage scaling while PID Tuning is recommended. This is due to normal battery voltage sag during flight and variations in battery performance. Params are MOT_BAT_VOLT_MAX, and MOT_BAT_VOLT_MIN. See :ref:`Current Limiting and Voltage scaling <current-limiting-and-voltage-scaling> for steps and procedures.  
